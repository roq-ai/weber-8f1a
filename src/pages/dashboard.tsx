...
import { useProjectCount, usePublicationCount, useResearchCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const researchStat = useResearchCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Research',
      result: researchStat?.data,
      isLoading: researchStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
