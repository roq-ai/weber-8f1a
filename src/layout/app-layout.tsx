...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['network-owner', 'researcher', 'scientist', 'collaborator', 'guest-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Research', path: '/research', entity: 'research', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
